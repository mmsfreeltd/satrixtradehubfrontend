...
import { SITE_ADDRESS, SITE_EMAIL, SITE_PHONE } from "@/global/constant";
...
const formSchema = z.object({
  ...
  inquiry: z.enum(["general", "sales", "support", "partnership"], {
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground">
              Have questions or need assistance? Reach out to our team and well
              be happy to help.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-2 mb-1">Sales:</p>
                      <a
                        href={`tel:${SITE_PHONE}`}
                        className="text-primary hover:underline"
                      >
              ...
              <div>
                ...
                <p className="mt-4 text-muted-foreground">
                  Our support team is available 24/7 for urgent trading issues.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  business days. For urgent matters, our support team is
                  available 24/7.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Yes, we offer in-person meetings at our headquarters for
                  enterprise clients and potential partners. Please contact us
